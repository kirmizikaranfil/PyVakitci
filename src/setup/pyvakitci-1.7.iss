...
OutputBaseFilename=pyvakitci-1.7-kurulum
SetupIconFile=
Compression=lzma
...
[Files]
Source: "C:\PyVakitci-exe\PyVakitci.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\PyVakitci-exe\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
